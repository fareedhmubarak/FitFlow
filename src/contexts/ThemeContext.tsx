...
export const themeConfigs: ThemeConfig[] = [
  ...
  },
  {
    id: 'instagram',
    name: 'Instagram Rose',
    description: 'Trendy rose gold & pink gradients',
    preview: {
      bg: '#FFF1F2',
      blob1: '#FB7185',
      blob2: '#F472B6',
  ...
  },
  {
    id: 'twitter',
    name: 'Twitter Blue',
    description: 'Clean sky blue & social vibes',
    preview: {
      bg: '#F0F9FF',
      blob1: '#38BDF8',
      blob2: '#818CF8',
  ...
  },
  {
    id: 'spotify',
    name: 'Spotify Mix',
    description: 'Energetic green & fresh composition',
    preview: {
      bg: '#F0FDF4',
      blob1: '#4ADE80',
      blob2: '#A3E635',
  ...
  },
  {
    id: 'tiktok',
    name: 'TikTok Viral',
    description: 'Modern monochrome with pop accents',
    preview: {
      bg: '#FAFAFA',
      blob1: '#F43F5E',
      blob2: '#2DD4BF',
  ...
  },
  {
    id: 'pearl',
    name: 'Pearl White',
    description: 'Elegant shimmering white & silver',
    preview: {
      bg: '#FFFFFF',
      blob1: '#E2E8F0',
      blob2: '#F1F5F9',
...
const THEME_STORAGE_KEY = 'fitflow-theme';
