      ...
      <div className='relative z-10 flex flex-col h-full'>
        ...
        <header className='flex-shrink-0 px-4 pb-2 relative z-50' style={{ paddingTop: 'max(1rem, env(safe-area-inset-top))' }}>
          ...
          <div className='flex items-center justify-between mb-2'>
            ...
            <h1 className='text-lg font-bold' style={{ color: 'var(--theme-text-primary, #0f172a)' }}>Dashboard <span className="text-[10px] font-medium text-emerald-600 bg-emerald-100 px-1.5 py-0.5 rounded-full">version 3</span></h1>
            <UserProfileDropdown />
          </div>
